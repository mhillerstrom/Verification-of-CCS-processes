...
Using proposition~\ref{propWeakBisim} it is easy to obtain similar characterization of $\approx$ using the following manguage $M_O$. Let the language $M_O$ of formulas be the least set such that:
\begin{enumerate}
\item $\dtt\in M_O$
